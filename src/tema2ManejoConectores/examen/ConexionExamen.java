...
public class ConexionExamen {
	private static final String URL = "jdbc:mysql://localhost:3306/zapatobd?allowMultiQueries=true";
	...
	public static Connection conectar() {
		...
		try {
			...
			System.out.println("Conexion exitosa a la base de datos 'zapatoBD'");
